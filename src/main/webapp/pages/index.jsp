...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
                ...
                <link rel="stylesheet" href="<% out.print(ROOT_URL);%>css/font-awesome-4.7.0/font-awesome-4.7.0/css/font-awesome.min.css">
                 <link rel="stylesheet" href="<% out.print(ROOT_URL);%>css/login.css">
...
<div class="" id="login-modal" tabindex="" role="" aria-labelledby="myModalLabel" aria-hidden="true">
    	  <div class="">
				<div class="loginmodal-container">
				
					<h1>Admin Login</h1><br>
				  <form action="<%out.print(ROOT_URL); %>loginAdmin" method="POST">
